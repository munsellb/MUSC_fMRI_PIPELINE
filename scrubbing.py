...
print "fsl_motion_outliers "+ subject_folder + "rsfMRI/*.nii.gz" +" -o "+ convert_folder +"Regress_Rest.feat/"+ subject_folder_name +"_confoundm.txt --fd --thresh=0.5"
print "-------------  Starting scrubbing  -------------"
os.system("fsl_motion_outliers -i "+ subject_folder + "rsfMRI/*.nii.gz" +" -o "+ convert_folder +"Regress_Rest.feat/"+ subject_folder_name +"_confoundm.txt --fd --thresh=0.5")
